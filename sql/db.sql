...
CREATE TABLE `item` (
  `item_id` varchar(5) NOT NULL DEFAULT '0',
...
--
DELIMITER $$
CREATE TRIGGER `tg_item_insert` BEFORE INSERT ON `item` FOR EACH ROW BEGIN
...
--
DELIMITER $$
CREATE TRIGGER `tg_user_insert` BEFORE INSERT ON `users` FOR EACH ROW BEGIN
